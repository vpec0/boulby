...
simple_geom_RunAction::~simple_geom_RunAction()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void simple_geom_RunAction::BeginOfRunAction(const G4Run* run)
{
...
void simple_geom_RunAction::EndOfRunAction(const G4Run* run)
{
  ...
  const simple_geom_PrimaryGeneratorAction* generatorAction
   = static_cast<const simple_geom_PrimaryGeneratorAction*>
