...
void process_proper_coinc_simple(const char* basedir = "data/full_geom_v0_4classes",
...
void fillDepositionVector(AnaTree::Event_t* evt, int detector, deposition_vector *deps, int class_separately)
{
    ...
    const double SUM_TIME = 1000.; // 1 ms
    double stop_looking = tdep[0] + SUM_TIME; // stop looking 1 ms after first deposition
