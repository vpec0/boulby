...
const char* base_dir[2] = {
    "plots/full_geom_v1_nacl_4classes_sortbugfix",
    "plots/full_geom_v1_polyhalite"};

const double scale[2] = { 1., 1.};

const size_t colors[2] = {kRed, kBlue};

const char* titles[2] = {"NaCl", "Polyhalite"};


const TString outpref("plots/full_geom_v1_compare_NaClPolyhalite/compare_nacl_polyhalite_");
...
void plotComparisons(HistMap_t& hists) {
	...
	// cout<<xaxis->GetXmin()<<" "<<xaxis->GetXmax()<<endl;
